...
public class Shakha {
    ...
    private String _$Description199; // FIXME check this code
    private int ListCount;
    private int ResultResponse;
    private List<SahtakBilDeniaObObject> SahtakBilDeniaOb;

    public static Shakha objectFromData(String str) {

        return new Gson().fromJson(str, Shakha.class);
    }

    public String get_$Description199() {
        return _$Description199;
    }

    public void set_$Description199(String _$Description199) {
        this._$Description199 = _$Description199;
    }
    ...
    public static class SahtakBilDeniaObObject {
        /**
