...
public class Featured_Test extends Fragment {
    ...
    java.util.List<com.webmarke8.app.medlab.Objects.Featured_Test.SahtakBilDeniaObObject> List;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                if (response.contains("Success")) {
                    ...
                    Gson gson = new Gson();
                    com.webmarke8.app.medlab.Objects.Featured_Test featured_test = new com.webmarke8.app.medlab.Objects.Featured_Test();
                    featured_test = gson.fromJson(response, com.webmarke8.app.medlab.Objects.Featured_Test.class);
