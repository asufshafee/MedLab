...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private static String NOTIFICATION_TYPE = "1";
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (GlobalActions.getDataToSharedPrefrences(SharedPrefrenceKeys.PUSH_ENABLED, getApplicationContext()).equals("true")) {
            ...
            NOTIFICATION_TYPE = remoteMessage.getMessageType();

            // notifies user
            sendNotification(remoteMessage.getNotification().getBody());
        } else {
            Log.e(MedlabsConstants.TAG, "Push is Disabled !!! ");
        }
...
//               HashMap<String,String> Data=convertToStringToHashMap(remoteMessage.getData().);
